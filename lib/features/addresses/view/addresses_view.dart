        ...
        body: Column(
          children: [
            Obx(() {
              ...
              final hasDefault =
                  controller.addresses.any((a) => a.isDefault);
                  ...
                  child: items.isEmpty
                      ? ListView(
                          ...
                          children: [
                            ...
                            const EmptyState(
                              message:
                                  'No saved addresses yet.\nAdd one for Home and job requests.',
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                count == 0
                    ? 'Places you use for Home and job requests'
                    : hasDefault
                        ? '$count saved · default set for Home'
                        : '$count saved · set a default for Home',
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500,
...
class _AddAddressCta extends StatefulWidget {
  const _AddAddressCta({required this.onPressed});

  final VoidCallback onPressed;

  @override
  State<_AddAddressCta> createState() => _AddAddressCtaState();
}

class _AddAddressCtaState extends State<_AddAddressCta> {
  bool _pressed = false;
